...
// Macro name
void Strangeness_3_Topo_1b_RGB_v1(){
  ...
  TFile fileOutput1("/mnt/f/PhD/Analysis_Output/RGB/Inclusive/Inbending/Strangeness_3/PID/Strangeness_3_Topo_1b_RGB_Inc_Pass1_Inbending_e_Kp_FD_011020_01.root","recreate");
  ...
  for(Long64_t i=0; i<nentries;i++){
    ...
    if(v_kp.size()==3 && v_el.size()==1){
      ...
      // Selecting events where 3 pions are also detected
      if(v_pim.size() == 3){
