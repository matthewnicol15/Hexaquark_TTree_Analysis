...
// Macro name
void Tree_Reader_Strangeness_Scaling_MC(){
   ...
   Data<<"S3_Sim_MC_RGB_Spring2019_Inbending_at_least_1e1KpFD_KpChi3_Tree_Total_23062022";
   Quantity<<"Total";
   Topology<<"Scaling";
   Date<<"23062022";
   Version<<"01";
   ...
   TFile *f = new TFile("/mnt/d/PhD/Trees/Simulations/Hexaquark/S3_Sim_job4904_Deuteron_Target_210622_01/S3_Sim_MC_job4904_10_6_Beam_Deuteron_Target_230622_01.root");
   ...
   TLorentzVector Target_Sim(0,0,0,0.93827); // Information on the target
   ...
   for(Long64_t i=0; i<nentries;i++){
      ...
      if(v_kp.size() == 1){
         ...
         h_S1_Kaon_Momentum__Miss_Mass__Kaon_Mass->Fill(v_kp.at(0).Rho(), Miss_S1_eKp.M(),v_kp.at(0).M());

         h_S1_Miss_Mass->Fill(Miss_S1_eKp.M());

         // Look at photon energy, missing mass and kaon mass
         h_S1_Photon_Energy__Miss_Mass__Kaon_Mass->Fill(Photon.E(),Miss_S1_eKp.M(),v_kp.at(0).M());
      }
      ...
      if(v_kp.size() == 2){
         ...
         h_S2_Kaon_Momentum__Miss_Mass__Kaon_Mass->Fill(v_kp.at(0).Rho(), Miss_S2_eKpKp.M(),v_kp.at(0).M());

         // Delta beta cut
         // if(v_kp.at(0).Rho() > 1.33 && v_kp.at(1).Rho() > 0.9 && fabs(v_delta_beta_kp.at(0)) < 0.02 && fabs(v_delta_beta_kp.at(1)) < 0.02){

         // Look at photon energy, missing mass and kaon mass
         h_S2_Photon_Energy__Miss_Mass__Kaon_Mass->Fill(Photon.E(),Miss_S2_eKpKp.M(),v_kp.at(0).M());
         // }
      }
      ...
      if(v_kp.size() == 3){
         ...
         // Miss_S3_eKpKpKp = beam + Target_Sim - v_el.at(0) - v_kp.at(0) - v_kp.at(1) - v_kp.at(2);
         ...
         h_S3_Kaon_Momentum__Miss_Mass__Kaon_Mass->Fill(v_kp.at(0).Rho(), Miss_S3_eKpKpKp.M(),v_kp.at(0).M());
         ...
         // Look at photon energy, missing mass and kaon mass
         h_S3_Photon_Energy__Miss_Mass__Kaon_Mass->Fill(Photon.E(),Miss_S3_eKpKpKp.M(),v_kp.at(0).M());
         // }
      }
   }
