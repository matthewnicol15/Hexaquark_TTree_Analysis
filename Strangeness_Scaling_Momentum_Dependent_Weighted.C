...
void Tree_Reader_Strangeness_Scaling(){
   ...
   Data<<"RGA_Fall2018_Inbending_at_least_1e1KpFD_Tree_Total_24022022";
   Quantity<<"Total";
   Topology<<"Scaling";
   Date<<"19052022";
   Version<<"02";
   ...
   // t1->SetBranchAddress("Photon_Energy",&Photon_Energy,"Photon_Energy/D");
   ...
   // t1->SetBranchAddress("negative_charge_tracks",&negative_charge_tracks);
   ...
   TFile *f2 = new TFile("/media/mn688/Elements1/PhD/Macros/Hexaquark_TTree_Analysis/Kaon_Background_Subtraction_RGA_Fall2018_Inbending_Alternative_19052022_02.root");
   ...
   TH2F *Signal_Function_S2 = new TH2F();
   TH2F *Background_Function_S2 = new TH2F();
   TH2F *Kaon_Mass_Momentum_S2 = new TH2F();

   Result = (TH2F*) f2->Get("Result");
   Signal_Function = (TH2F*) f2->Get("Signal_Function");
   Background_Function = (TH2F*) f2->Get("Background_Function");
   Kaon_Mass_Momentum = (TH2F*) f2->Get("h_S1_Kaon_Momentum__Miss_Mass__Kaon_Mass_xz");

   Result_S2 = (TH2F*) f2->Get("Result_S2");
   Signal_Function_S2 = (TH2F*) f2->Get("Signal_Function_S2");
   Background_Function_S2 = (TH2F*) f2->Get("Background_Function_S2");
   Kaon_Mass_Momentum_S2 = (TH2F*) f2->Get("h_S1_Kaon_Momentum__Miss_Mass__Kaon_Mass_xz");
   ...
   auto* h_S1_Photon_Energy__Miss_Mass__Kaon_Mass_weighted = new TH3F("h_S1_Photon_Energy__Miss_Mass__Kaon_Mass_weighted","Photon energy, missing mass and kaon mass",120,0,12,300,0,3,500,0.3,0.8);
   ...
   auto* h_S2_Photon_Energy__Miss_Mass__Kaon_Mass_weighted = new TH3F("h_S2_Photon_Energy__Miss_Mass__Kaon_Mass_weighted","Photon energy, missing mass and kaon mass",120,0,12,300,0,3,500,0.3,0.8);
   ...
   auto* h_S2_Kaon_Momentum__Miss_Mass__Kaon_Mass_Sig = new TH3F("h_S2_Kaon_Momentum__Miss_Mass__Kaon_Mass_Sig","Kaon momentum, missing mass and kaon mass",300,0,3,300,0,3,500,0.3,0.8);
   auto* h_S2_Kaon_Momentum__Miss_Mass__Kaon_Mass_Back = new TH3F("h_S2_Kaon_Momentum__Miss_Mass__Kaon_Mass_Back","Kaon momentum, missing mass and kaon mass",300,0,3,300,0,3,500,0.3,0.8);
   ...
   auto* h_S1_Miss_Mass_Sig = new TH1F("h_S1_Miss_Mass_Sig","Missing Mass",300,0,3);
   auto* h_S1_Miss_Mass_Back = new TH1F("h_S1_Miss_Mass_Back","Missing Mass",300,0,3);
   ...
   Double_t Signal_Value, Background_Value;
   Double_t Signal_Weight, Signal_Weight_S2;
   ...
   for(Long64_t i=0; i<nentries;i++){
      ...
      if(v_kp.size() == 1){
         ...
         Signal_Value = Signal_Function->GetBinContent(Signal_Function->GetXaxis()->FindBin(v_Mass_kp.at(0)),Signal_Function->GetYaxis()->FindBin(v_kp.at(0).Rho()));
         Background_Value = Background_Function->GetBinContent(Background_Function->GetXaxis()->FindBin(v_Mass_kp.at(0)),Background_Function->GetYaxis()->FindBin(v_kp.at(0).Rho()));
         // Signal_Weight = Signal_Function->GetBinContent(Signal_Function->GetXaxis()->FindBin(v_Mass_kp.at(0)),Signal_Function->GetYaxis()->FindBin(v_kp.at(0).Rho())) - Background_Function->GetBinContent(Background_Function->GetXaxis()->FindBin(v_Mass_kp.at(0)),Background_Function->GetYaxis()->FindBin(v_kp.at(0).Rho()));
         if(Signal_Value > 0)
         Signal_Weight = Signal_Value / (Signal_Value + Background_Value);
         else Signal_Weight = 0;
         Background_Weight = 1 - Signal_Weight;
         // cout<< "signal value is " << Signal_Value << " Background value is " << Background_Value <<
         // " Signal weight is " << Signal_Weight << " Background Weight is " << Background_Weight << endl;
         // Signal_Weight = Result->GetBinContent(Result->GetXaxis()->FindBin(v_Mass_kp.at(0)),Result->GetYaxis()->FindBin(v_kp.at(0).Rho()));
         // Background_Weight = 1 - Signal_Weight;
         ...
         h_S1_Miss_Mass_Sig->Fill(Miss_S1_eKp.M(),Signal_Weight);
         h_S1_Miss_Mass_Back->Fill(Miss_S1_eKp.M(),Background_Weight);
         ...
         h_S1_Photon_Energy__Miss_Mass__Kaon_Mass_weighted->Fill(Photon.E(),Miss_S1_eKp.M(),v_Mass_kp.at(0),Signal_Weight);
      }

      // Strangness 2
      if(v_kp.size() == 2){

         Signal_Weight_S2 = Result_S2->GetBinContent(Result_S2->GetXaxis()->FindBin(v_Mass_kp.at(0)),Result_S2->GetYaxis()->FindBin(v_kp.at(0).Rho()));

         // cout << "Signal weight S2 is " << Signal_Weight << endl;
         ...
         h_S2_Kaon_Momentum__Miss_Mass__Kaon_Mass_Sig->Fill(v_kp.at(0).Rho(), Miss_S2_eKpKp.M(),v_Mass_kp.at(0),Signal_Weight_S2);
         h_S2_Kaon_Momentum__Miss_Mass__Kaon_Mass_Back->Fill(v_kp.at(0).Rho(), Miss_S2_eKpKp.M(),v_Mass_kp.at(0),1-Signal_Weight_S2);
         ...
         h_S2_Photon_Energy__Miss_Mass__Kaon_Mass_weighted->Fill(Photon.E(),Miss_S2_eKpKp.M(),v_Mass_kp.at(0),Signal_Weight_S2);
         // }
      }
   ...
   Double_t Sig_Integral = h_S1_Kaon_Momentum__Miss_Mass__Kaon_Mass->Integral(h_S1_Kaon_Momentum__Miss_Mass__Kaon_Mass->GetYaxis()->FindBin(0.0),h_S1_Kaon_Momentum__Miss_Mass__Kaon_Mass->GetYaxis()->FindBin(0.9));
   ...
   // h_S1_Kaon_Momentum__Miss_Mass__Kaon_Mass->Add(h_S1_Kaon_Momentum__Miss_Mass__Kaon_Mass_Back,-1);
